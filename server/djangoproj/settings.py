    ...
    <div class="card" style="width: 80%;margin: auto; margin-top:5%;">
      ...
      <div class="card" style="width: 30%;">
        ...
        <div class="card-body">
          ...
          <p>Mr. White</p>
          <p class="card-text">The best car dealer in the world</p>
          <p>m.white@gmail.com</p>
        </div>
      </div>
      ...
      <div class="card" style="width: 30%;">
        ...
        <div class="card-body">
          ...
          <p>Mr. Black</p>
          <p class="card-text">The best speaker in the world</p>
          <p>m.black@gmail.com</p>
        </div>
      </div>
      ...
      <div class="card" style="width: 30%;">
        ...
        <div class="card-body">
          ...
          <p>Ms. Rutherford</p>
          <p class="card-text">The only one who works here</p>
          <p>s.rutherford@gmail.com</p>
        </div>
      </div>
    </div>
    </div>
